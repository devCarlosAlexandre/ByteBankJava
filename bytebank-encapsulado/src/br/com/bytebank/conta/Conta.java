...
/**
 * Classe abstrata onde centraliza todas as funcionalidade em comum de uma conta
 * do Bytebank.
 * 
...
public abstract class Conta {
	...
	/**
	 * Parar instanciar um filho da classe conta é necessario passar como
	 * paramentros numero inteiro de uma agencia e um numero inteiro da numeração da
	 * conta, onde nem o numero da conta e nem o numero da agencia podem ser iagual
